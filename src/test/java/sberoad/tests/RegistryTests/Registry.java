...
public class Registry extends TestBase {
    ...
    private String barcodeDoc;
    private String barcodeInventory;
    @Test
    public void RegistryV1() throws InterruptedException {
        ...
        for (int z= 0;z<i;z++) {
           barcodeDoc = DBArrays3random.documentBarcodeinstate("02");
    ...
    public void RegistryV2() throws InterruptedException {
        ...
        for (int z= 0;z<i;z++) {
            barcodeDoc = DBArrays3random.dailybindingBarcodeinstate("02");
    ...
    public void RegistryV3() throws InterruptedException {
        ...
        String invstate;
        for (int z = 0; z<i; z++) {
            barcodeInventory = DBArrays3random.inventoryBarcodeinstate("04");
            ...
            boolean b = docsates.stream().allMatch(s -> s.equals("05"));
