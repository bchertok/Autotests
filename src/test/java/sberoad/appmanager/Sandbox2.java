...
//       System.out.println(DBArraysTEML.TEinStatesWithorWithoutTE("2", "is null", false,true));
        RandomFromList rnd = new RandomFromList(DBArraysTEML.TEinStatesWithorWithoutTE("2", "is null", false, false));
